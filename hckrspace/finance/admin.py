...
from finance.models import Subject, Currency, Period_Unit, Obligation_Period, Sink, Sink_Period, Exchange_Event_Data, Event, Money_Chunk


admin.site.register(Currency)
admin.site.register(Period_Unit)
